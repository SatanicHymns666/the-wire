...
The system runs daily. Each file is a snapshot of one UTC day, organized across fourteen categories: Earth, Water, Sky, Infrastructure, Aviation, Maritime, Violence, Public Spaces, Political, Economic, Health, Space, and Unexplained. Each entry carries a headline, a set of extracted keywords, the source name, and a direct link. Nothing is editorialized inside the data blocks. Other systems read these files. The format stays clean.

The files are never deleted. Whatever the world did on a given day, it stays in the archive. That is the only policy.

## Latest Feed

[2026-06-02] — 11 entries
[feed/2026-06-02.md](feed/2026-06-02.md)
